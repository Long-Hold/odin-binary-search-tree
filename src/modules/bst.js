...
export class Tree {
  ...
  insert(value) {
    ...
    function appendToBranchEnd(value, currentNode) {
      ...
      if (value > currentNode.value)
        currentNode.right = appendToBranchEnd(value, currentNode.right);
  ...
  /**
   * Calls a callBack function on each Node's value in order.
   *
  ...
  /**
   * Calls a callback function on each node's value in pre-order.
   *
   * @param {Function} callBack - The function to be called on each Node's value.
   * @returns {this} An instance of the object for chaining.
   */
